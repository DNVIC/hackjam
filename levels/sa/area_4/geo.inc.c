...
const GeoLayout sa_area_4_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 0, 6406, -2013, 90, 0, 0, sa_dl_island_002_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 255, 2505, -2694, 0, 180, 0, sa_dl_main_003_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
