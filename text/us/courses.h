COURSE_ACTS(COURSE_BOB, _(" 1 TUTORIAL LEVEL"),
       _("NO STAR HINTS")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _(" 2 CASTLE OF PROPORTIONS"),
       _("NO STAR HINTS")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
...
COURSE_ACTS(COURSE_CCM, _(" 4 Waterfall Woodlands"),
       _("NO STAR HINTS")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
...
COURSE_ACTS(COURSE_TTC, _("14 RUINS OF THE ABYSS"),
       _("NO STAR HINTS")            , _("THE PIT AND THE PENDULUMS")     , _("GET A HAND"),
       _("STOMP ON THE THWOMP")           , _("TIMED JUMPS ON MOVING BARS")    , _("STOP TIME FOR RED COINS"))

COURSE_ACTS(COURSE_RR, _("15 CLOUDY PLAINS"),
       _("NO STAR HINTS")  , _("THE BIG HOUSE IN THE SKY")      , _("COINS AMASSED IN A MAZE"),
